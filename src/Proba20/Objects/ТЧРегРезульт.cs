...
namespace IIS.Proba20
{
    ...
    public class ТЧРегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba20.ИтогСобес fИтогСобес;
        
        private int fОценкаКандид;
        
        private string fКрКомИлиОбсРеш;
        
        private IIS.Proba20.Сотрудники fСотрудники;
        
        private IIS.Proba20.РегРезульт fРегРезульт;
        ...
        public virtual IIS.Proba20.ИтогСобес ИтогСобес
        {
            get
            {
                ...
                IIS.Proba20.ИтогСобес result = this.fИтогСобес;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Proba20.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Proba20.Сотрудники result = this.fСотрудники;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Proba20.РегРезульт.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РегРезульт"})]
        public virtual IIS.Proba20.РегРезульт РегРезульт
        {
            get
            {
                ...
                IIS.Proba20.РегРезульт result = this.fРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧРегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧРегРезультE", typeof(IIS.Proba20.ТЧРегРезульт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧРегРезульт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Proba20.DetailArrayOfТЧРегРезульт members)

        // *** End programmer edit section *** (IIS.Proba20.DetailArrayOfТЧРегРезульт members)
        ...
        /// </summary>
        public DetailArrayOfТЧРегРезульт(IIS.Proba20.РегРезульт fРегРезульт) : 
                base(typeof(ТЧРегРезульт), ((ICSSoft.STORMNET.DataObject)(fРегРезульт)))
        {
        }
        
        public IIS.Proba20.ТЧРегРезульт this[int index]
        {
            get
            {
                return ((IIS.Proba20.ТЧРегРезульт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Proba20.ТЧРегРезульт dataobject)
        {
