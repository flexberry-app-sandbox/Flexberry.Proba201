...
namespace IIS.Proba20
{
    ...
    public class ГрафСобес : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba20.DetailArrayOfТЧГрафСобес fТЧГрафСобес;
        ...
        public virtual IIS.Proba20.DetailArrayOfТЧГрафСобес ТЧГрафСобес
        {
            get
            {
                ...
                {
                    this.fТЧГрафСобес = new IIS.Proba20.DetailArrayOfТЧГрафСобес(this);
                }
                IIS.Proba20.DetailArrayOfТЧГрафСобес result = this.fТЧГрафСобес;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ГрафСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГрафСобесE", typeof(IIS.Proba20.ГрафСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ГрафСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГрафСобесL", typeof(IIS.Proba20.ГрафСобес));
                }
            }
        }
    }
