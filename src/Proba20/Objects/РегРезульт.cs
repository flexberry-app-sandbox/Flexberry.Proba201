...
namespace IIS.Proba20
{
    ...
    public class РегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba20.DetailArrayOfТЧРегРезульт fТЧРегРезульт;
        ...
        public virtual IIS.Proba20.DetailArrayOfТЧРегРезульт ТЧРегРезульт
        {
            get
            {
                ...
                {
                    this.fТЧРегРезульт = new IIS.Proba20.DetailArrayOfТЧРегРезульт(this);
                }
                IIS.Proba20.DetailArrayOfТЧРегРезульт result = this.fТЧРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультE", typeof(IIS.Proba20.РегРезульт));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегРезультL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультL", typeof(IIS.Proba20.РегРезульт));
                }
            }
        }
    }
