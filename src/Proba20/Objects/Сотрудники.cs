...
namespace IIS.Proba20
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba20.ДолжнСотр fДолжнСотр;
        ...
        [PropertyStorage(new string[] {
                "ДолжнСотр"})]
        [NotNull()]
        public virtual IIS.Proba20.ДолжнСотр ДолжнСотр
        {
            get
            {
                ...
                IIS.Proba20.ДолжнСотр result = this.fДолжнСотр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Proba20.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Proba20.Сотрудники));
                }
            }
        }
    }
